...
#include <franka_ros_controllers/joint_wall.h>
#include <franka_ros_controllers/teleop_joint_pd_example_controller.h>
...
bool TeleopJointPDExampleController::init(hardware_interface::RobotHW* robot_hw,
  ...
  if (debug_) {
    ...
    dynamic_server_teleop_param_ = std::make_unique<
        dynamic_reconfigure::Server<franka_ros_controllers::teleop_paramConfig>>(
...
void TeleopJointPDExampleController::teleopParamCallback(
    franka_ros_controllers::teleop_paramConfig& config,
    uint32_t /*level*/) {
...
PLUGINLIB_EXPORT_CLASS(franka_ros_controllers::TeleopJointPDExampleController,
