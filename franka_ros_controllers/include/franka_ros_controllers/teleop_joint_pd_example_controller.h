...
#include <franka_ros_controllers/teleop_paramConfig.h>
...
class TeleopJointPDExampleController : public controller_interface::MultiInterfaceController<
 ...
 private:
  ...
  std::unique_ptr<dynamic_reconfigure::Server<franka_ros_controllers::teleop_paramConfig>>
      dynamic_server_teleop_param_;
  void teleopParamCallback(franka_ros_controllers::teleop_paramConfig& config, uint32_t level);
